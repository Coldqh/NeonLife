...
check("save migration normalizes social state", migration.includes("normalizeSocialState(payload.social") && read("src/core/saves/types.ts").includes("SAVE_SCHEMA_VERSION = 34"));
