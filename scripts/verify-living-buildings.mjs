...
check("shop clinic courier and home actions are wired", ["buy-food", "clinic-care", "accept-courier", "pickup-courier", "deliver-courier", "sleep-home"].every((token) => service.includes(token)));
