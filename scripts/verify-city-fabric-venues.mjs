...
check("package version is 0.39.2", packageJson.version === "0.39.2");
check("save schema is 33", saves.includes("SAVE_SCHEMA_VERSION = 33"));
...
check("urban fabric version is 2", urbanTypes.includes("version: 2") && urban.includes("version: 2"));
