...
check("venue service points use real domain actions", servicePanel.includes("LocalLifeAction") && servicePanel.includes("buy-venue-offer") && servicePanel.includes("join-venue-queue") && servicePanel.includes("accept-courier") && servicePanel.includes("<VenueWorkPanel"));
