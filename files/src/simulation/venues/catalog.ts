...
const TEMPLATES: Record<VenueCategory, VenueOfferTemplate[]> = {
  ...
  clothing: [
    ...
    { code: "PLATE", name: "SECURITY PLATE VEST", description: "Тяжёлый бронежилет частной охраны.", kind: "equipment", productId: "security-plate-vest", price: 460, stock: 4, durationMinutes: 12 }
  ],
  entertainment: [
  ...
  "shooting-range": [],
  "weapon-shop": [
    { code: "KNUCKLES", name: "BRASS KNUCKLES", description: "Стальной кастет без серийного номера.", kind: "equipment", productId: "brass-knuckles", price: 180, stock: 8, durationMinutes: 6 },
    { code: "KNIFE", name: "COMBAT KNIFE", description: "Боевой нож с усиленным клинком.", kind: "equipment", productId: "combat-knife", price: 460, stock: 5, durationMinutes: 8 },
    { code: "P9", name: "CUTWIRE P9", description: "Дешёвый нелегальный пистолет.", kind: "equipment", productId: "cheap-pistol", price: 1450, stock: 2, durationMinutes: 12 }
  ]
};
