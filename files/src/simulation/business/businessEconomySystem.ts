...
const CATEGORY_PRODUCTS: Partial<Record<UnifiedBusinessState["category"], ProductCategory[]>> = {
  ...
  gym: ["drink", "apparel"],
  "boxing-gym": ["drink", "apparel"],
  "shooting-range": ["weapon", "electronics"],
  "weapon-shop": ["weapon", "armor"],
...
const SERVICE_CATEGORIES = new Set<UnifiedBusinessState["category"]>(["clinic", "repair", "cyberware", "entertainment", "hotel", "office-service", "gym", "boxing-gym", "shooting-range", "logistics", "corporate", "education", "government", "transport"]);
