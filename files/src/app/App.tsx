...
export default function App() {
  ...
  return (
    <div className={rootClass}>
      ...
      >
        {screen === "profile" ? <ProfileScreen session={session} onOpen={setScreen} onRouteTo={routeToLocation} onAction={runLocalLifeAction} /> : null}
        {screen === "map" ? (
          <MapScreen
        ...
        {screen === "work" ? <WorkScreen session={session} onAction={runLocalLifeAction} onOpenVenue={openVenueOnMap} onRouteTo={routeToLocation} /> : null}
