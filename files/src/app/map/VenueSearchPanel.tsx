...
const CATEGORY_OPTIONS: Array<{ value: "all" | VenueCategory; label: string }> = [
  ...
  { value: "boxing-gym", label: "Боксёрские залы" },
  { value: "shooting-range", label: "Тиры" },
  { value: "weapon-shop", label: "Оружие" }
];
  ...
  return (
    <aside className="venue-search" data-no-swipe>
      ...
      <div className="venue-search__controls">
        <label><span>Название или услуга</span><input autoFocus value={query} onChange={(event) => setQuery(event.target.value)} placeholder="кафе, бокс, тир, оружие…" /></label>
