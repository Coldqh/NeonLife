...
assert(migrated.payload.playerLoop.activeJobId === "meshline-runner", "legacy courier contract did not map to the simple job");
...
assert(migrated.payload.player.occupation.includes("КУРЬЕР"), "migrated occupation was not projected from player loop");
...
console.log(JSON.stringify({
  ...
  simpleJob: migrated.payload.playerLoop.activeJobId,
