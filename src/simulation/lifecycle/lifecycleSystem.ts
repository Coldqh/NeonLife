  ...
  residents = residents.map((resident) => {
    ...
    if (tuition > 0) {
      ...
      transactions.push({
        ...
        creditEntityId: institution.ownerOrganizationId ?? kernelSystemEntityId(input.seed, "city-services"),
        resource: "credits",
        amount: tuition,
    ...
    if (publicCost > 0 && institution.ownerOrganizationId) {
      ...
      if (funded > 0) transactions.push({
        ...
        creditEntityId: kernelSystemEntityId(input.seed, "city-services"),
        resource: "credits",
        amount: funded,
        reason: "education-service",
