...
- вакансии, создаваемые фактическим дефицитом персонала бизнеса;
- шесть профессиональных навыков фоновых жителей;
- карьерные приоритеты: доход, стабильность, расстояние, дневная смена и развитие;
- реальные заявки жителей на конкретные рабочие места;
- конкуренция кандидатов и оценка соответствия требованиям;
- переходы работающих жителей между работодателями;
- рост навыка и опыта во время работы;
- удовлетворённость, производительность и накопленное давление ухода;
- повышение предложения зарплаты при долгом поиске;
- зарплатное давление по районам;
- история вакансий, заявок, наймов, уходов и сокращений;
- вкладка «ТРУД» в наблюдении за населением;
- миграция сохранений на схему 11.

### Изменено

- удалён старый случайный повторный найм с фиксированным шансом;
- целевой штат бизнеса теперь связан с реальным числом рабочих записей;
- старые сохранения автоматически исправляют заниженный `targetStaff`;
- добровольный уход требует длительного неудовлетворения, а не единичного плохого дня;
- сокращения, закрытия и невыплата зарплаты получают отдельную причину увольнения;
- версия приложения и PWA повышена до `0.13.0`.

### Проверено

- расширение бизнеса создаёт вакансии;
- несколько жителей конкурируют за одно место;
- найм меняет физического работодателя;
- прежняя рабочая точка теряет перешедшего сотрудника;
- история заявок и вакансий ограничена по размеру;
- 90 игровых суток проходят без схлопывания занятости и бесконечного накопления вакансий.
